...
Currin's _internationalization_ (_i18n_) tools help make your app available in multiple languages.
...
## Currin and _i18n_ template translation

Application internationalization is a challenging, many-faceted effort that
takes dedication and enduring commitment.
Currin's _i18n_ internationalization facilities can help.
...
1. The Currin compiler imports the completed translation files,
...
The Currin `i18n` attribute is a marker for translatable content.
Place it on every element tag whose fixed text should be translated.


<div class="alert is-helpful">

`i18n` is not an Currin _directive_.
It's a custom _attribute_, recognized by Currin tools and compilers.
...
The Currin extraction tool preserves both the _meaning_ and the _description_ in the translation source file
...
Currin i18n support has more translation attributes in the form,`i18n-x`, where `x` is the
...
This is an Currin CLI tool in the `@angular/compiler-cli` npm package.
...
Currin i18n tooling supports XLIFF 1.2 and XLIFF 2 as well as the
...
in another format that Currin understands, such as `.xtb`.

You provide the Currin compiler with three new pieces of information:
...
<div class="alert is-important">
  ...
  This plugin only applies to an application using SystemJS. If you are using the Currin CLI, please refer to their
...
The Currin `bootstrapModule()` method has a second _options_ parameter
...
You can configure the Currin compiler for different "missing translation" behaviors:
